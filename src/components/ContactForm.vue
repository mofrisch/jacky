    ...
    <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
      <div class="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
        <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
          ...
          <h2 class="text-3xl font-bold tracking-tight text-gray-900">Hast du Interesse?</h2>
          <p class="mt-6 text-lg leading-8 text-gray-600">Schick mir eine Nachricht oder ruf mich an.</p>
          <dl class="mt-10 space-y-4 text-base leading-7 text-gray-600">
            <div class="flex gap-x-4">
              ...
              <dd>Zum Apothekerhof 6<br />60594 Frankfurt</dd>
            </div>
            <div class="flex gap-x-4">
              <dt class="flex-none">
              ...
              <dd><a class="hover:text-gray-900" href="tel:+1 (555) 234-5678">069-12345678</a></dd>
            </div>
            <div class="flex gap-x-4">
              <dt class="flex-none">
              ...
              <dd><a class="hover:text-gray-900" href="mailto:jaqueline-ruehl@gmx.de">jaqueline-ruehl@gmx.de</a></dd>
            </div>
          </dl>
        </div>
      </div>
      <form action="https://usebasin.com/f/5c975cf1ab7a" method="POST"
        ...
        <div class="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
          <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
            ...
            <div class="sm:col-span-2">
              <label for="message" class="block text-sm font-semibold leading-6 text-gray-900">Deine Nachricht</label>
              <div class="mt-2.5">
          ...
          <div class="mt-8 flex justify-end">
            <button type="submit"
              class="rounded-md bg-indigo-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Nachricht
              senden</button>
          </div>
        </div>
      </form>
